...
public:
    ...
    void setDisplayText();
    string formatDisplayText(const int& score, const int& level, const int& lives, const int& health, const int& ammo, const int& bonus);
    string formatLevel(const int& lev);
